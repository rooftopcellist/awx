...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0077_v350_schedule_analytics_template'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='job_type',
            field=models.CharField(blank=True, choices=[('cleanup_jobs', 'Remove jobs older than a certain number of days'), ('cleanup_activitystream', 'Remove activity stream entries older than a certain number of days'), ('cleanup_facts', 'Purge and/or reduce the granularity of system tracking data'), ('gather_analytics', 'Collects and sends Automation Insights data'), ('clearsessions', 'Removes expired browser sessions from the database'), ('cleartokens', 'Removes expired OAuth 2 access tokens and refresh tokens')], default='', max_length=32),
        ),
        migrations.AlterField(
